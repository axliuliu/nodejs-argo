...
const UUID = process.env.UUID || '70c6b924-9327-477e-b504-36661c6fb65e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'NwxKJwM9UKRCX5TBPaBm0IrjNCSyflif';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
